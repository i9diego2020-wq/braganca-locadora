...
export const BenefitsBar: React.FC = () => {
  const benefits = [
    { icon: Truck, title: 'ENTREGA RÁPIDA', subtitle: 'Entrega no Mesmo Dia na Obra', highlight: false },
    { icon: DollarSign, title: 'MELHOR PREÇO', subtitle: 'da Região de Bragança', highlight: false },
    { icon: ShieldCheck, title: 'COBRIMOS QUALQUER OFERTA', subtitle: 'Garantia do Menor Valor', highlight: true },
    { icon: Headset, title: 'ATENDIMENTO RÁPIDO', subtitle: 'Especializado em Obra', highlight: false },
  ];
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-3 rounded-xl shadow-xs bg-[#ff6a00] text-white">
                ...
                <div>
                  ...
                  <p className="font-inter text-xs text-[#5a4136]">{benefit.subtitle}</p>
                </div>
              </div>
            );
          })}
