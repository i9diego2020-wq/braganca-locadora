      ...
      <div className="max-w-[900px] mx-auto px-4 md:px-6">
        ...
        <div className="space-y-3">
          {FAQS.map((faq, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-2xl border border-[#e2bfb0] overflow-hidden shadow-xs transition-all">
                <button
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-[#ff6a00] transition-transform duration-300 flex-shrink-0 ${isOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                {isOpen && (
